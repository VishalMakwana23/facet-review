...
- Gate: **PASS**
- Renderer compiled entry: 34405 bytes

| Candidate | o200k median reduction | cl100k median reduction | Equality/checks | Gate |
|---|---:|---:|---|---|
| tree | 95.57% | 95.56% | pass | PASS |
| graph | 95.4% | 95.36% | pass | PASS |
| tuple | 96.38% | 96.32% | pass | PASS |

Compact revisions: 11.7% median and 15.85% maximum of the selected full artifact (o200k_base, 40 revisions).

MVP total-output gate: **PASS** — 95.55% median reduction and 95.31% p10 reduction across initial output plus two revisions.
