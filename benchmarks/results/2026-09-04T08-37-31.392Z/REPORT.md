...
- Gate: **PASS**
- Renderer compiled entry: 34193 bytes

| Candidate | o200k median reduction | cl100k median reduction | Equality/checks | Gate |
|---|---:|---:|---|---|
| tree | 95.65% | 95.64% | pass | PASS |
| graph | 95.47% | 95.44% | pass | PASS |
| tuple | 96.44% | 96.39% | pass | PASS |

Compact revisions: 11.7% median and 15.85% maximum of the selected full artifact (o200k_base, 40 revisions).

MVP total-output gate: **PASS** — 95.62% median reduction and 95.38% p10 reduction across initial output plus two revisions.

Cached HTML host sensitivity: 55.44% median and 48.63% p10. This removes shared HTML chrome from output costs; do not generalize the main gate to reusable-host competitors.
