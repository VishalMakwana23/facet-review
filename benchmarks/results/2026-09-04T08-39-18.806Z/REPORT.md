...
- Gate: **PASS**
- Renderer compiled entry: 34327 bytes

| Candidate | o200k median reduction | cl100k median reduction | Equality/checks | Gate |
|---|---:|---:|---|---|
| tree | 95.67% | 95.66% | pass | PASS |
| graph | 95.49% | 95.46% | pass | PASS |
| tuple | 96.46% | 96.41% | pass | PASS |

Compact revisions: 11.7% median and 15.85% maximum of the selected full artifact (o200k_base, 40 revisions).

MVP total-output gate: **PASS** — 95.64% median reduction and 95.41% p10 reduction across initial output plus two revisions.
